...
class RV2LAdapter (val items:MutableList<String>) : RecyclerView.Adapter<RV2LAdapter.ViewHolder>(){
    val recommend: Recommend ?= null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RV2LAdapter.ViewHolder{
        val view = LayoutInflater.from(parent.context).inflate(R.layout.rv_item2, parent, false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: RV2LAdapter.ViewHolder, position: Int) {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        fun bindItem(item : String){
            ...
            rv_btn.setOnClickListener{
                ...
                val rv2intent = Intent(itemView.context, Management2Activity::class.java)
