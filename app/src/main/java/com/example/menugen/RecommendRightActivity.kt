...
//            add(RecommendData(photo = R.drawable.muchim, largeMenuName = "대분류: 무침류", smallMenuName = food4.toString()))
            ...
            add(RecommendData(photo = R.drawable.noodle, largeMenuName = "대분류: 면류", smallMenuName = "임시"))
            add(RecommendData(photo = R.drawable.fried, largeMenuName = "대분류: 부침류", smallMenuName = "임시"))
            add(RecommendData(photo = R.drawable.kimchi, largeMenuName = "대분류: 김치류", smallMenuName = "임시"))
            add(RecommendData(photo = R.drawable.milk, largeMenuName = "대분류: 유제품류", smallMenuName = "임시"))
