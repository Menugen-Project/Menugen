...
class management3 : AppCompatActivity() {
    // 데이터 바인딩
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
                ...
                override fun onItemSelected(
                    ...
                    if(position == 0){
                        ...
                        if(Large_food == "밥"){
                            ...
                            recycler.layoutManager = LinearLayoutManager(this@management3)
                        }
                        ...
                        val middle_food_adapter = ArrayAdapter(this@management3, android.R.layout.simple_list_item_1,Middel_food_list)
        ...
        if(db.dao().getTitle().isEmpty() == false){
            ...
            recycler2.layoutManager = LinearLayoutManager(this@management3)
        }
        ...
        binding.SettingFinBtn.setOnClickListener{
            val nextintent = Intent(this@management3,SettingActivity::class.java)
            nextintent.putExtra("List", arrayOf(items2))
