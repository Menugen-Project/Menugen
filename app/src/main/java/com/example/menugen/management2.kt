...
class Management2Activity : AppCompatActivity() {
    // 데이터 바인딩
    private lateinit var binding: ActivityManagement2Binding
    private lateinit var adapter: RVLAdapter
    private lateinit var adapter2: RV2LAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 어댑터 연결
        adapter = RVLAdapter(items)
        adapter2 = RV2LAdapter(items)
            ...
            object : AdapterView.OnItemSelectedListener {
                override fun onItemSelected(
                    ...
                    if(position == 0){
                        ...
                        val middle_food_adapter = ArrayAdapter(this@Management2Activity, android.R.layout.simple_list_item_1,Middle_food_list)
                ...
                override fun onItemSelected(
                    ...
                    if (position == 0) {
                        ...
                        if(Middle_food == "쌀밥"){
                            ...
                            val rvAdapter = RVLAdapter(items)
                            recycler.adapter = rvAdapter

                            recycler.layoutManager = LinearLayoutManager(this@Management2Activity)
                        }
                    }
                }
                override fun onNothingSelected(parent: AdapterView<*>?) {}
        ...
        if(db.dao().getEmptyTitle().isNotEmpty()){
            ...
            val rv2Adapter = RV2LAdapter(items2)
            recycler2.adapter = rv2Adapter

            recycler2.layoutManager = LinearLayoutManager(this@Management2Activity)
        }


        // DB 초기화 + 식단 저장 + 화면 전환(management2으로)
                ...
                .enqueue(object : Callback<Join> {
                    ...
                    override fun onResponse(call: Call<Join>, response: Response<Join>) {
                        ...
                        if(serverCheck?.code==200){
                            val nextintent = Intent(this@Management2Activity,SettingActivity::class.java)
                            ...
                            Toast.makeText(this@Management2Activity, "실패! $serverCheck.code", Toast.LENGTH_LONG).show()
                        }
                    }
                })
